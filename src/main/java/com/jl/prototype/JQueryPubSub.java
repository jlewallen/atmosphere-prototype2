 ...
 * https://jersey.dev.java.net/CDDL+GPL.html or jersey/legal/LICENSE.txt. See the License for the specific language
 ...
 * jersey/legal/LICENSE.txt. Sun designates this particular file as subject to the "Classpath" exception as provided by
 * Sun in the GPL Version 2 section of the License file that accompanied this code. If applicable, add the following
 ...
 * 2] license." If you don't indicate a single choice of license, a recipient has the option to distribute your version
...
/**
 * Simple PubSub resource that demonstrate many functionality supported by Atmosphere JQuery Plugin and Atmosphere
 * Jersey extension.
 * 
...
public class JQueryPubSub {
   ...
   private static final Logger logger = LoggerFactory.getLogger(JQueryPubSub.class);
   ...
   public SuspendResponse<String> subscribe() {
      ...
      return new SuspendResponse.SuspendResponseBuilder<String>().broadcaster(topic).resumeOnBroadcast(true).outputComments(true).addListener(new EventsLogger()).build();
   }
   ...
   public Broadcastable publish(@FormParam("message") String message) {
      ...
      return new Broadcastable(message, "callee " + message, topic);
   }

   @GET
   @Broadcast
   @Path("/test")
   public Broadcastable test() {
      logger.info("test");
