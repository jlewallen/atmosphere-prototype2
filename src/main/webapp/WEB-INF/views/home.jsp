    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function subscribe() {
                ...
                var location = document.location.toString() + 'atmosphere/pubsub/' + getElementByIdValue('topic');
            ...
            getElementById('phrase').onkeyup = function(event) {
                ...
                if (keyc == 13 || keyc == 10) {
                    ...
                    connectedEndpoint.push(document.location.toString() + 'atmosphere/pubsub/' + getElementByIdValue('topic'),
                            null,
            ...
            getElementById('send_message').onclick = function(event) {
                ...
                connectedEndpoint.push(document.location.toString() + 'atmosphere/pubsub/' + getElementById('topic').value,
                        null,
                        $.atmosphere.request = {data: 'message=' + getElementByIdValue('phrase') + m});
